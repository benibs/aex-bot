      ...
      [
        {
            ...
            description: `└ contoh: ${prefix}setName BOT STYLE GROUP`
        },
        {
        ...
        {
            command: `🤖 ${prefix} *add*`,
            description: `└ contoh: ${prefix}add 082114499086`
        },
        {
      ...
      [
        {
            ...
            description: `└ contoh: ${prefix}botjoin https://chat.whatsapp.com/F4iO1UxDaUOGE7itha7alG`
        },
        {
            command: `🤖 ${prefix} *igdl*`,
            description: `└ contoh: ${prefix}igdl https://www.instagram.com/beni_230/`
        },
        {
            command: `🤖 ${prefix} *ytmp3*`,
            description: `└ contoh: ${prefix}ytmp3 https://youtu.be/eCGt-9tCpLs`
        },
        {
            command: `🤖 ${prefix} *ytmp4*`,
            description: `└ contoh: ${prefix}ytmp4 https://youtu.be/eCGt-9tCpLs`
        },
        {
            command: `🤖 ${prefix} *qr*`,
        ...
        },
        {
            ...
            description: `└ contoh: ${prefix}artinama Benni Ismael`
        },
        {
        ...
        },
        {
            ...
            description: `└ contoh: ${prefix}sifat Benni 24/12/2002`
        },
        {
            command: `🤖 ${prefix} *jnt*`,
...
via Pulsa Tsel: 0821-1449-9086
via Paypal: https://www.paypal.com/paypalme/BenniIsmael
